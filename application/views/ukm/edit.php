        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Ukm</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="" method="POST">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="hidden" name="id_kategori" value="<?=isset($Ukm) ? $Ukm->id_kategori : '' ?>">
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Ukm" value="<?=isset($Ukm) ? $Ukm->nama_kategori : '' ?>">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
